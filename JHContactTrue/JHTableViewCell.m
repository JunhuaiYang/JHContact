...
//    static NSMutableArray<UIColor *> *color = [NSMutableArray array];
...
//    [color addObject:[UIColor grayColor]];
//    [color addObject:[UIColor orangeColor]];
//    [color addObject:[UIColor brownColor]];
//    [color addObject:[UIColor yellowColor]];
